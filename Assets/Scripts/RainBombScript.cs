...
public class RainBombScript : MonoBehaviour
{
    ...
    public void LaunchRainBomb(Vector3 enemyPosition)
    {
        ...
        Collider rainBombCollider = rainBomb.GetComponent<Collider>();
        if (shieldCollider != null && rainBombCollider != null)
        {
            Physics.IgnoreCollision(shieldCollider, rainBombCollider);
        }
        if (playerCollider != null && rainBombCollider != null)
        {
            Physics.IgnoreCollision(playerCollider, rainBombCollider);
        }
